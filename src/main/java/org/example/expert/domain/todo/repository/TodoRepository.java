...
import org.example.expert.domain.user.repository.UserRepositoryCustom;
...
public interface TodoRepository extends JpaRepository<Todo, Long>, UserRepositoryCustom {
